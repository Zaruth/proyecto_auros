...
/**
 * Controlador del servicio de mensajería
 * @Route("/juego/message")
 */
class MessageController extends Controller
{
    ...
    */
    ...
    /**
     * Muestra el listado de mensajes
     ...
     */
    public function new(Request $request, UserController $uc, UserRepository $userRepository): Response
    {   
        if($uc->check_ban($this->getUser())){
            return $this->redirectToRoute('logout');
        }else{
