 ...
 */
final class Version20180614224546 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE equipment (id INT AUTO_INCREMENT NOT NULL, statid_id INT NOT NULL, itemid_id INT NOT NULL, type VARCHAR(255) NOT NULL, subtype VARCHAR(255) NOT NULL, hands INT DEFAULT 0 NOT NULL, class VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_D338D5833291518 (statid_id), UNIQUE INDEX UNIQ_D338D583EA51AAB7 (itemid_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE have_items (id INT AUTO_INCREMENT NOT NULL, charac_id INT NOT NULL, item_id INT NOT NULL, quantity INT DEFAULT 1 NOT NULL, inuse TINYINT(1) NOT NULL, INDEX IDX_3F7E632FF03E368 (charac_id), UNIQUE INDEX UNIQ_3F7E632126F525E (item_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE item (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, img VARCHAR(255) NOT NULL, purchaselvl INT DEFAULT 1 NOT NULL, foundlvl INT DEFAULT 1 NOT NULL, uselvl INT DEFAULT 1 NOT NULL, goldvalue INT DEFAULT 0 NOT NULL, silvervalue INT DEFAULT 0 NOT NULL, coppervalue INT DEFAULT 0 NOT NULL, exp INT DEFAULT 0 NOT NULL, description LONGTEXT NOT NULL, uses INT DEFAULT 0 NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
